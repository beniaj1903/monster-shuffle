...
use super::effects::{is_grounded, check_ability_immunity, modify_offensive_stat_by_ability};
...
pub(crate) fn parse_type(type_str: &str) -> PokemonType {
...
pub(crate) fn get_effective_speed(pokemon: &PokemonInstance) -> f32 {
